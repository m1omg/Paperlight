...
(function (P) {
  ...
  const HOW = {
    ...
    "Wheat Seeds": ["Break grass or tall grass: seeds drop now and then (about 1 in 8), so walk through a grassy field breaking everything. Village farms have them too, and every grown wheat you harvest gives more seeds back.", "wheat seed|seeds|seed"],
  ...
  const guides = [
    ...
    { q: ["explain minecraft simply", "what is minecraft", "how do you play minecraft", "explain minecraft for a grandmother", "minecraft in a nutshell", "what exactly is minecraft", "what is minecraft exactly", "explain minecraft in simple terms", "explain minecraft to me", "can you explain minecraft", "what do you do in minecraft", "what do you actually do in the game", "what is the point of minecraft", "how does minecraft work"],
    ...
    { q: ["is minecraft safe for kids", "is minecraft safe for a 9 year old", "is minecraft multiplayer safe", "can strangers talk to my son", "strangers on minecraft servers", "is it safe to play minecraft online", "is minecraft safe online"],
      a: "Minecraft itself is very kid-friendly: blocky, low-gore, and great for creativity. The risk is online multiplayer, where strangers can chat. Safer ways to play: a private Realm or a world shared only with friends and family, turning chat off or to \"commands only\" (in Settings > Chat), and using Xbox / Microsoft Family Safety to limit multiplayer, friend requests and chat. Playing together now and then, and telling kids to never share personal info or move to another app with someone they met in the game, goes a long way." },
    { q: ["minecraft parental controls", "how do i set up parental controls for minecraft", "turn off chat in minecraft", "can i turn off the chat", "block strangers in minecraft", "family settings minecraft"],
      a: "Parental controls for Minecraft live in the Microsoft account: go to Microsoft Family Safety (family.microsoft.com) or the Xbox Family Settings app, add your child, then turn off or limit \"join multiplayer games\", \"communicate with others\" and friend requests. In the game you can also set Chat to \"Hidden\" or \"Commands only\" under Settings > Chat. On Java edition, only join servers you trust, or run a private world. On consoles (Switch, PlayStation), use that console's parental controls too." },
    { q: ["can i turn off the chat in minecraft", "turn off chat in minecraft", "stop strangers messaging my son in minecraft", "can strangers message my child in minecraft", "how do i turn off minecraft chat"],
      a: "Yes. In the game itself there's a chat setting (on Java: Options → Chat Settings → Chat: Hidden). For a lock your child can't just turn back on, use the Xbox Family Settings app or family.microsoft.com and set communication with others to friends only, or turn it off. Playing on a private Realm or with friends only also keeps strangers out." },
    { q: ["is the nether scary", "is the nether scary for kids", "is the nether too scary", "is the nether scary for a 9 year old", "is the nether safe"],
      a: "It's a little spooky, but not gory: the Nether is dark red and full of lava, and ghasts make crying sounds and shoot fireballs. 🔥 Most kids find it exciting rather than scary, especially with a grown-up along. Tips: water evaporates there, so bring blocks to wall off lava, wear at least one piece of gold armor so piglins stay calm, and switch to Peaceful difficulty if it's too much." },
    { q: ["what is the nether", "what is the nether in minecraft", "what is in the nether", "what is the end in minecraft", "what is the end dimension"],
      a: "The Nether is Minecraft's fiery underworld: a second dimension you reach through a purple portal made of obsidian. It's full of lava seas, red and blue forests, and tougher mobs (ghasts that shoot fireballs, piglins, blazes). It's a bit spooky but not gory; most kids find it exciting rather than scary. The End is the third dimension, a dark island where the final boss, the Ender Dragon, lives." },
    { q: ["what is hp", "what are hearts in minecraft", "what does health mean in minecraft", "health points in minecraft"],
      a: "HP means \"health points\": how much damage something can take before it's defeated. ❤️ In Minecraft, 2 HP = 1 heart. You have 20 HP (10 hearts), a creeper has 20, and the Ender Dragon has 200!" },
    { q: ["what is a mob", "what does mob mean", "what is a mob in minecraft", "what are mobs", "what do you mean by a mob", "what do you mean by mob"],
