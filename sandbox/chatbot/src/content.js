...
(function (P) {
  ...
  const intents = [
    ...
    { id: "bot_feel", ex: ["do you have feelings", "can you feel", "do you have emotions", "are you alive", "are you conscious", "are you sentient", "do you dream", "can you think", "do you get lonely", "do you have a soul", "are you self aware"],
      re: /\bdo (you|u) (have|feel|get) (feelings|emotions|a soul|lonely|sad|happy|bored)\b|\bcan (you|u) (feel|think|dream|love)\b|\b(are|r) (you|u) (alive|conscious|sentient|self aware|self-aware)\b|\bdo you dream\b/,
    ...
    { id: "game", ex: ["let's play a game", "play a game", "i want to play", "what games can we play", "can we play something", "game", "play with me", "wanna play a game"], re: /\b(play|start) (a |another |some |the )?games?\b|\bwhat games\b|^games?$|\bplay (with me|something)\b|\bwanna play\b/,
