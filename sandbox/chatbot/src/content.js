...
(function (P) {
  ...
  const intents = [
    ...
    { id: "good_night", ex: ["good night", "night night", "gn", "going to sleep", "i am going to bed", "time for bed", "i need to sleep", "sleep well", "nighty night", "i am tired i am going to sleep"],
      re: /\b(good ?night|night night|nighty night|going to (sleep|bed)|going to go (to )?sleep|off to (sleep|bed)|time for bed|gotta sleep|go to sleep now|heading to bed|gn)\b|\bnight[!. ]*$|\bnite[!. ]*$/,
